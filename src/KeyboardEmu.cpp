...
Adafruit_USBD_HID KeyboardEmu::keyboard;

uint8_t const KeyboardEmu::desc_hid_report[] = {TUD_HID_REPORT_DESC_KEYBOARD()};

uint8_t KeyboardEmu::pins[] = {D0, D1, D2, D3};
uint8_t KeyboardEmu::pincount = sizeof(pins) / sizeof(pins[0]);
uint8_t KeyboardEmu::hidcode[] = {HID_KEY_0, HID_KEY_1, HID_KEY_2, HID_KEY_3};
bool KeyboardEmu::activeState = false;

void KeyboardEmu::process_hid() {
...
const KeyName KeyboardEmu::keyMap[] = {{KEY_LEFT_CTRL, "KEY_LEFT_CTRL"},
...
const int KeyboardEmu::keyMapSize = sizeof(keyMap) / sizeof(keyMap[0]);
